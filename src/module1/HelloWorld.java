...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		Asmara = new UnfoldingMap(this, 150, 50,350,600, provider);
		Asmara = new UnfoldingMap(this, 150,50,250,600, provider); 

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    //map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    //Asmara.zoomAndPanTo(zoomLevel,  new Location(32.9f , 117.2));
	    
	    
	    Asmara.zoomAndPanTo(zoomLevel, new Location(15.3258061f,38.66867f)); 
		
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, Asmara);
		//MapUtils.createDefaultEventDispatcher(this, Asmara); 
		
		// TODO: Add code here that creates map2 
		Asmara = new UnfoldingMap(this, 50, 50,350,600, provider);
	    Asmara.zoomAndPanTo(zoomLevel, new Location(5.32, 38.84));
	    MapUtils.createDefaultEventDispatcher(this, Asmara); 
