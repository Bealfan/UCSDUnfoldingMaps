	...
	private void printQuakes() 
	{
		...
		for(Marker earthquake: quakeMarkers){
			...
			//If occurred on land
				...
				if (earthquake.getProperty("country".toLowerCase()) == "china") 
					chineseEarthquake++; 
				}
		...
		System.out.print("OCEAN QUAKES: "+ oceanQuakesCount);
		System.out.println("Chinese Earthquakes on Quiz 1 atom: " + chineseEarthquake );
